 ...
 * dans public/sport/exercises/<idExercice>-1.jpg et <idExercice>-2.jpg.
 *
 ...
 *     public/sport/exercises/ ; l'app les affiche automatiquement.
 * ────────────────────────────────────────────────────────────────────────────
 */
...
const outDir = join(root, 'public', 'sport', 'exercises')
...
console.log(`\nTerminé : ${ok} exercices, ${fail} échecs. Images dans public/sport/exercises/`)
