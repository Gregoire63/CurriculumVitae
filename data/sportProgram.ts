...
export const PROGRAM: Session[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'curl-ez', name: 'Curl barre EZ', sets: 3, reps: '8-10', muscles: ['biceps'], cues: ['Coudes collés au buste, zéro élan', 'Contrôle la descente (2-3 sec)', 'Contraction max en haut'], machine: '' },
    ],
  },
  {
    id: 's3',
