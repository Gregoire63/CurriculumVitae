...
export const PROGRAM: Session[] = [
  ...
  },
  {
    ...
    sprint: SPRINT,
    exercises: [
      { id: 'tirage-v', name: 'Tirage vertical', sets: 4, reps: '8-10', muscles: ['dos', 'biceps'], cues: ['Prise légèrement plus large que les épaules', 'Tire vers le haut des pecs, coudes vers le bas', 'Ne te balance pas en arrière'], machine: 'Ou tractions lestées si maîtrisées' },
